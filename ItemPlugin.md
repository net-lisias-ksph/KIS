...
Take note that `ModuleKISItem` class run on the **part prefab module**, as the part do not exist in the scene when the item is in the inventory, So you will need to use KIS specific methods to keep track of the item and use.
