...
- Change stack increment quantity to 10 : Hold `Shift` while clicking (context menu)
- Change stack increment quantity to 100 : Hold `Ctrl` while clicking (context menu)
