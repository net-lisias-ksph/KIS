...
- `equipMode`: Can be "model" or "physic". "model" will only show the item model on equip and "physic" will attach the part to the kerbal Eva (please note that this option is pretty buggy and the part will not follow Kerbal bones correctly)
- `equipSlot`: 
- `equipTrait`: 
- `equipRemoveHelmet`: 
- `equipMeshName`: 
